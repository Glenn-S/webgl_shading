/**
 * To bind the context of the canvas and clear it's frame
 */
class GLCommander {
  // bind gl
  init(gl) {
    this.gl = gl; // store reference to canvas context
  }
...
const GLC = new GLCommander(); // create new object to export for each new call
